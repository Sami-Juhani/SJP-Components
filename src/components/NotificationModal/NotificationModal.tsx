...
export type NotificationModalProps = {
  text: string;
  type: "success" | "notification" | "warning" | "alert";
  isOpen: boolean;
  onClose: () => void;
...
export function NotificationModal({
  ...
  return createPortal(
    ...
    (document.getElementById("storybook-root") as HTMLDivElement) ||
      (document.getElementById("notification-modal") as HTMLDivElement)
  );
}
